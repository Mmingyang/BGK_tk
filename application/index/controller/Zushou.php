...
//
//        //取出租数据
//        $zus= ZushouModel::where("zushou", 0)->select();
////        halt($zus);
//        //取出售数据
//        $shous= ZushouModel::where("zushou", 1)->select();
////        halt($shous);
//        //显示视图
//        return view('index', compact('zus','shous'));
//    }
//
//
//    public function detail($id)
//    {
//        $zushous = ZushouModel::get($id);
//
//        return view("detail", compact("zushous"));
//
//    }
    ...
    {
        //取数据
        $notices=ZushouModel::where("status",1)->select();
        //显示视图传输数据
//        halt($notice);
...
//        halt($data);
    ...
    {
        $notices = Db::name("cms_zushou")->where("grade",$id)->select();
